...
public:
	...
	struct alignas(16) Point_Shadow_Constants
	{
		DirectX::XMFLOAT4 position_radius;
		DirectX::XMFLOAT4 params;
		DirectX::XMFLOAT4 options;
		DirectX::XMFLOAT4 padding; // 16バイトアライメントのためのパディング
	};
	static_assert(sizeof(Point_Shadow_Constants) % 16 == 0, "Point_Shadow_Constants must be 16-byte aligned");
